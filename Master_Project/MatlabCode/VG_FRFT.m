...
[K, Y] = VG_FRFT_PRICES(S,params, N, a, b, alpha);
...
function [K, Y] = VG_FRFT_PRICES(S, params, N, a, b, alpha)
...
eps = 0.5*lamb*delta/pi;    % Fractional parameter
